...
import type { LayoutState, Occurrence, RenderedEdge, SwimlaneRect } from 'event-modeling-spec-cli/layout/types';
import type { LaneDescriptor, VisualizationSnapshot } from 'event-modeling-spec-cli/viewer-contract/types';
