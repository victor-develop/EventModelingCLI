import type { DiffStatus } from 'event-modeling-spec-cli/viewer-contract/types';
import { getVisibleLaneLabel, toVisibleLane, type VisibleLane } from 'event-modeling-spec-cli/viewer-contract/lanePolicy';
