...
import type { LayoutPatch, RenderedEdge } from 'event-modeling-spec-cli/layout/types';
...
const ROOT = path.resolve(__dirname, '../../../../../packages/cli/tests/fixtures/xyflow-spec/04-xyflow-adapter-components');
